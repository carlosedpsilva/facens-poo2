...
--TB_EVENT
INSERT INTO tb_event (admin_base_user_id, name, description, start_date, end_date, start_time, end_time, email, amount_free_tickets_available, amount_paid_tickets_available, ticket_price)
VALUES
