...
import static br.facens.poo2.event.scheduler.util.SchedulerUtils.ASSOCIATED_OPEATION_MESSAGE;
import static br.facens.poo2.event.scheduler.util.SchedulerUtils.ASSOCIATION_MESSAGE;
...
import static br.facens.poo2.event.scheduler.util.SchedulerUtils.Entity.PLACE;
import static br.facens.poo2.event.scheduler.util.SchedulerUtils.Operation.ASSOCIATED;
import static br.facens.poo2.event.scheduler.util.SchedulerUtils.Operation.DEASSOCIATED;
